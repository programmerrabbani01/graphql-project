...
export const AccountActivationEmail = async (email, data) => {
  ...
  await transport.sendMail({
    from: "Messenger <gr5669291@gmail.com>",
    to: email,
...
<div style="font-family: sans-serif">
<div class="" style="font-size: 12px; font-family: Arial, Helvetica, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2;">
<p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;"><em><strong>Your Account Activation Code IS : ${data.code}</strong></em></p>
</div>
</div>
</td>
</tr>
